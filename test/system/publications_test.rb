...
class PublicationsTest < ApplicationSystemTestCase
  ...
  test "should create publication" do
    ...
    fill_in "Contenido", with: @publication.contenido
    fill_in "Fecha publicacion", with: @publication.fecha_publicacion
    fill_in "Titulo", with: @publication.titulo
    fill_in "Ubicacion", with: @publication.ubicacion
